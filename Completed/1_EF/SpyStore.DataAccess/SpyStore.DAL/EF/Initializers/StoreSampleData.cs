...
namespace SpyStore.DAL.EF.Initializers
{
    public static class StoreSampleData
    {
        ...
        public static IEnumerable<Customer> GetAllCustomerRecords(SpyStoreContext context) => new List<Customer>
        {
            new Customer()
            {
        ...
        public static IList<Order> GetOrders(Customer customer) => new List<Order>
        {
            new Order()
            {
                Customer = customer,
        ...
        public static IList<OrderDetail> GetOrderDetails(
            Order order, SpyStoreContext context)
        {
        ...
        public static IList<ShoppingCartRecord> GetCart(
            Customer customer, SpyStoreContext context)
        {
